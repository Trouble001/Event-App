const Slide = ({ slide, active }) => {
  ...
  return (
    <div
      className={`absolute top-0 w-full pb-20 md:pb-0 md:pl-22 pl-2 bg-black/20 pr-2 h-full flex items-center justify-center transition-all duration-700 ${active ? "flex" : "hidden"}`}
      >
